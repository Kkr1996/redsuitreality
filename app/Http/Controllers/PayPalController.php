...
//        Ayhl3VkPk-T-esybdCWd4IL5c9rIAS7HDFUjJEvahaSTi1-i5jSYKkfW
//          9XTR5V7XKBJD39B7
            
            
        $paymentsettings = Paymentsetting::where('slug','paypal')->first();
        
        
        $client_id = $paymentsettings->live_api_signature;
        $secret    = $paymentsettings->live_api_password;
        
        
        
//        $client_id = "AW6uEkENQM7SOQtbtvTjTIQjMc3YEJG3xjArOexTCGlATC3oj6daRy10TFqBdoNSQ2OizxuHP5UrPw_S";
//        $secret    = "EIphAQreLKjOhwmmx2QAOiVQikKSJOz26uYgon-7P3JBep74sd2oMj3TwkjPuArpFRwvdELLwvhZLMYP";
//        
        $mode      = strtolower($paymentsettings->environment);
           ...
           //Invoice to the customer
            ...
            foreach($orders_details as $keyvalue)
            {
                ...
                foreach ($data as $key => $value) {
                    $p_data = DB::table('auctions')->where('id',$value)->get();
