...
class PasswordController extends BaseController
{
    ...
    public function getemails()
    {
        ...
        if($data)
        {
            ...
            ->where('email',$email)
            ->update($values);
            $subject                =  "Redsuitrealty - Update Password";
            $from                   =  "info@redsuitrealty.com";
            $fromName               =  "Redsuitrealty";
            $emailSubject           =  "Redsuitrealty";
            $email                  =  "info@redsuitrealty.com";
            $img                    =  url('public/storage/uploads/images/logo/282.redsuit-logo.png');
            $url                    =  url('/forgotpasswords/').'/'.$verify_id;
